...
TEST_F(S21MatrixTest, constructorWithParameters) {
  ...
  EXPECT_THROW(matrix_temp = new S21Matrix(-1, 3), std::out_of_range);
}

TEST_F(S21MatrixTest, constructorWithParametersError) {
  EXPECT_THROW(matrix_temp = new S21Matrix(-1, 2), std::out_of_range);
}
...
TEST_F(S21MatrixTest, set_colsAndRows) {
  ...
  EXPECT_THROW(matrix_3x3->set_rows(-1), std::length_error);
  matrix_3x3->set_cols(4);
  EXPECT_EQ(4, matrix_3x3->get_cols());
  matrix_3x3->set_cols(0);
  EXPECT_EQ(0, matrix_3x3->get_cols());
}
...
TEST_F(S21MatrixTest, TestDeterminantException1) {
...
TEST_F(S21MatrixTest, TestDeterminantException2) {
...
TEST_F(S21MatrixTest, TestDeterminantException3) {
...
TEST_F(S21MatrixTest, TestDeterminantException4) {
...
TEST_F(S21MatrixTest, TestDeterminantZero1) {
  ...
  EXPECT_NEAR(result_check, result, kEpsilon);
  EXPECT_TRUE(matrix1 == matrix_before);
}

TEST_F(S21MatrixTest, TestDeterminantZero2) {
...
TEST_F(S21MatrixTest, TestDeterminantZero3) {
  S21Matrix matrix1{3, 3};
  EXPECT_EQ(matrix1.get_cols(), 3);
  EXPECT_EQ(matrix1.get_rows(), 3);
...
TEST_F(S21MatrixTest, TestDeterminantZero4) {
  S21Matrix matrix1{3, 3};
  EXPECT_EQ(matrix1.get_cols(), 3);
  EXPECT_EQ(matrix1.get_rows(), 3);
...
TEST_F(S21MatrixTest, TestDeterminantZero5) {
  S21Matrix matrix1{3, 3};
  EXPECT_EQ(matrix1.get_cols(), 3);
  EXPECT_EQ(matrix1.get_rows(), 3);
...
TEST_F(S21MatrixTest, TestDeterminantZero6) {
...
TEST_F(S21MatrixTest, TestDeterminantZero7) {
...
TEST_F(S21MatrixTest, TestDeterminantZero9) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminantZero10) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminantZero11) {
  S21Matrix matrix1{5, 5};
...
TEST_F(S21MatrixTest, TestDeterminantZero12) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminantZero13) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminantZero15) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminantZero16) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminantZero18) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminantZero19) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminantZero20) {
...
TEST_F(S21MatrixTest, TestDeterminantZero21) {
  S21Matrix matrix1{2, 2};
  EXPECT_EQ(matrix1.get_cols(), 2);
  EXPECT_EQ(matrix1.get_rows(), 2);
...
TEST_F(S21MatrixTest, TestDeterminantZero22) {
  S21Matrix matrix1{2, 2};
  EXPECT_EQ(matrix1.get_cols(), 2);
  EXPECT_EQ(matrix1.get_rows(), 2);
...
TEST_F(S21MatrixTest, TestDeterminantZero23) {
  S21Matrix matrix1{2, 2};
  EXPECT_EQ(matrix1.get_cols(), 2);
  EXPECT_EQ(matrix1.get_rows(), 2);
...
TEST_F(S21MatrixTest, TestDeterminantZero24) {
  S21Matrix matrix1{3, 3};
  EXPECT_EQ(matrix1.get_cols(), 3);
  EXPECT_EQ(matrix1.get_rows(), 3);
...
TEST_F(S21MatrixTest, TestDeterminantZero25) {
  S21Matrix matrix1{4, 4};
  EXPECT_EQ(matrix1.get_cols(), 4);
  EXPECT_EQ(matrix1.get_rows(), 4);
...
TEST_F(S21MatrixTest, TestDeterminantZero26) {
  S21Matrix matrix1{1, 1};
  EXPECT_EQ(matrix1.get_cols(), 1);
  EXPECT_EQ(matrix1.get_rows(), 1);
...
TEST_F(S21MatrixTest, TestDeterminantZero27) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminantZero28) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminantZero29) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminantZero30) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminant1) {
  S21Matrix matrix1{1, 1};
  EXPECT_EQ(matrix1.get_cols(), 1);
  EXPECT_EQ(matrix1.get_rows(), 1);
...
TEST_F(S21MatrixTest, TestDeterminant2) {
  S21Matrix matrix1{2, 2};
  EXPECT_EQ(matrix1.get_cols(), 2);
  EXPECT_EQ(matrix1.get_rows(), 2);
...
TEST_F(S21MatrixTest, TestDeterminant3) {
  S21Matrix matrix1{2, 2};
  EXPECT_EQ(matrix1.get_cols(), 2);
  EXPECT_EQ(matrix1.get_rows(), 2);
...
TEST_F(S21MatrixTest, TestDeterminant4) {
  S21Matrix matrix1{3, 3};
  EXPECT_EQ(matrix1.get_cols(), 3);
  EXPECT_EQ(matrix1.get_rows(), 3);
...
TEST_F(S21MatrixTest, TestDeterminant5) {
  S21Matrix matrix1{3, 3};
  EXPECT_EQ(matrix1.get_cols(), 3);
  EXPECT_EQ(matrix1.get_rows(), 3);
...
TEST_F(S21MatrixTest, TestDeterminant6) {
  S21Matrix matrix1{4, 4};
  EXPECT_EQ(matrix1.get_cols(), 4);
  EXPECT_EQ(matrix1.get_rows(), 4);
...
TEST_F(S21MatrixTest, TestDeterminant7) {
  S21Matrix matrix1{4, 4};
  EXPECT_EQ(matrix1.get_cols(), 4);
  EXPECT_EQ(matrix1.get_rows(), 4);
...
TEST_F(S21MatrixTest, TestDeterminant8) {
  S21Matrix matrix1{5, 5};
  EXPECT_EQ(matrix1.get_cols(), 5);
  EXPECT_EQ(matrix1.get_rows(), 5);
...
TEST_F(S21MatrixTest, TestDeterminant9) {
...
TEST_F(S21MatrixTest, TestDeterminant10) {
...
TEST_F(S21MatrixTest, TestDeterminant11) {
...
TEST_F(S21MatrixTest, TestDeterminant12) {
  // TEST_TIMEOUT_BEGIN;
